...
df = fread('C:/Users/dtrangmoe/Documents/Churchill/Data/Churchill_Merged_CF1_CF3_HH.csv',na.strings = c('-9999','NA','NaN','NAN','-7999'))

#needs continuous day variable
df_avg = fread('C:/Users/dtrangmoe/Documents/Churchill/Data/Churchill_Merged_Avg_CF1_CF3_HH.csv',na.strings = c('-9999','NA','NaN','NAN','-7999'))
...
df_avg_2023 <- subset(df_avg, df_avg$TIMESTAMP > as.POSIXct("2022-12-31 2330"))
df_2023 <- subset(df, df$TIMESTAMP > as.POSIXct("2022-12-31 2330"))
