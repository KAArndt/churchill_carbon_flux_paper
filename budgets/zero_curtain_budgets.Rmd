...
## SWC Soil temp and therm profile soil temp comparison

```{r}

ggplot(data = df_all)+
  geom_point(aes(x = TS_2_05_1, y = TS_4_1_1))

cor.test(df_all$TS_2_05_1, df_all$TS_4_1_1)
