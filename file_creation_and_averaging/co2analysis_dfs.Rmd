...
df_y1 <- subset(df_23_24_25, (df_23_24_25$TIMESTAMP < as.POSIXct("2023-09-05 00:00")))

df_avg_y1 <- subset(df_avg_23_24_25, (df_avg_23_24_25$date < as.POSIXct("2023-09-05")))



df_y2 <- subset(df_23_24_25, ((df_23_24_25$TIMESTAMP >= as.POSIXct("2023-09-06 00:00")) & (df_23_24_25$TIMESTAMP < as.POSIXct("2024-09-12 00:00"))))

df_avg_y2 <- subset(df_avg_23_24_25, ((df_avg_23_24_25$date >= as.POSIXct("2023-09-06")) & (df_avg_23_24_25$date < as.POSIXct("2024-09-12"))))


df_y3 <- subset(df_23_24_25, (df_23_24_25$TIMESTAMP >= as.POSIXct("2024-09-13 00:00")))

df_avg_y3 <- subset(df_avg_23_24_25, (df_avg_23_24_25$date >= as.POSIXct("2024-09-13")))
```
