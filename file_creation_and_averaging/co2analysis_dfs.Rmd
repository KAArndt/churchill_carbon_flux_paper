...
df_avg_23_24_25 <- subset(df_avg, ((df_avg$date > as.POSIXct("2022-09-18 00:00")) & (df_avg$date < as.POSIXct("2026-01-01 00:00"))))

df_23_24_25 <- subset(df, ((df$TIMESTAMP > as.POSIXct("2022-09-18 00:00")) & (df$TIMESTAMP < as.POSIXct("2026-01-01 00:00"))))
