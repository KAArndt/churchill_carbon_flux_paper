...
How much data was removed by cleaning?
```{r}

percent_removed_co2 <- (sum(is.na(df_23_24_25$FC)) - sum(is.na(df_23_24_25$FC_UC)))/sum(!is.na(df_23_24_25$FC))

percent_removed_ch4 <- (sum(is.na(df_23_24_25$FCH4)) - sum(is.na(df_23_24_25$FCH4_UC)))/sum(!is.na(df_23_24_25$FCH4))
...
Start of fall 1: 09-18-2022; DOY 261
End of fall 1: 10-15-2022; DOY 288
end of winter 1, 05-04-23; DOY 124
end of snowmelt 1, 06-11-23; DOY 162
end of growing season 1, 09-05-23; DOY 248

end of fall 2, 10-21-23; DOY 294
...
End of winter 3:05-21-2025 ; DOY 141
End of snowmelt 3: 06-16-2025 ; DOY 167
End of growing season 3: 09-10-25; DOY 253
