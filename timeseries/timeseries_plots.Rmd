...
carbonts <- ggplot(data = df_avg_23_24, aes(x=date))+
  theme_bw() + theme(axis.text.x = element_text(size = 16, angle = 45, vjust = 1, hjust = 1), axis.text.y = element_text(size = 16),    axis.title = element_text(size = 16), legend.title = element_blank(), legend.text = element_text(size = 12))+
  ...
  scale_x_date(name = NULL, limits = as.Date(c("2022-09-19","2025-09-10")), expand = expansion(0),
...
soiltempts <- ggplot(data = df_avg_23_24)+ theme_bw() + theme(axis.text.x = element_text(size = 16, angle = 45, vjust = 1, hjust = 1), axis.text.y = element_text(size = 16),    axis.title = element_text(size = 16), legend.title = element_blank(), legend.text = element_text(size = 12))+
...
swc_ts <- ggplot(data = df_avg_23_24, aes(x=date))+
  ...
  geom_vline(xintercept = as.Date("2024-09-13"), col = "black")+
  geom_vline(xintercept = as.Date("2025-09-10"), col = "black")+
  scale_y_continuous(limits = c(0, 78), expression('Soil Water Content (%)'))+
  scale_x_date(name = NULL, limits = as.Date(c("2022-09-19","2025-09-10")), expand = expansion(0),
                   breaks = seq(as.Date("2022-09-01"), as.Date("2025-09-01"), by = "4 months"), date_labels = "%b %Y")+
  # scale_shape_manual(name = NULL,
  #           values = c("Gapfilled" = 1,
...
temp_ts <- ggplot(data = df_avg_23_24, aes(x=date))+
  ...
  geom_vline(xintercept = as.Date("2024-09-13"), col = "black")+
  geom_vline(xintercept = as.Date("2025-09-10"), col = "black")+
  scale_y_continuous(limits = c(-36, 24), expression('Temperature ('*degree*'C)'))+
  scale_x_date(name = NULL, limits = as.Date(c("2022-09-19","2025-09-10")), expand = expansion(0),
                   breaks = seq(as.Date("2022-09-01"), as.Date("2025-09-01"), by = "4 months"), date_labels = "%b %Y")+
...
png(filename = './png/all_2_ts.png',width = 11,height = 11.5,units = 'in',res = 2000)
co2_ts / ch4_ts / temp_ts / snow_ts  + plot_layout(guides = "collect", axes = "collect")
dev.off()
...
gpp_ts <- ggplot(data = df_avg_23_24, aes(x=date))+
  ...
  geom_vline(xintercept = as.Date("2024-09-13"), col = "black")+
  geom_vline(xintercept = as.Date("2025-09-10"), col = "black")+
  scale_y_continuous(limits = c(-0.5, 4.2), expression('GPP (g C'~m^-2~d^-1*')'))+
  scale_x_date(name = NULL, limits = as.Date(c("2022-09-19","2025-09-10")), expand = expansion(0),
                   breaks = seq(as.Date("2022-09-01"), as.Date("2025-09-01"), by = "4 months"), date_labels = "%b %Y")+
  scale_linetype_manual(name = NULL,
            values = c("Air Temp" = "solid",
...
reco_ts <- ggplot(data = df_avg_23_24, aes(x=date))+
  ...
  geom_vline(xintercept = as.Date("2024-09-13"), col = "black")+
  geom_vline(xintercept = as.Date("2025-09-10"), col = "black")+
  scale_y_continuous(limits = c(-0.5, 4.2), expression('RECO (g C'~m^-2~d^-1*')'))+
  scale_x_date(name = NULL, limits = as.Date(c("2022-09-19","2025-09-10")), expand = expansion(0),
                   breaks = seq(as.Date("2022-09-01"), as.Date("2025-09-01"), by = "4 months"), date_labels = "%b %Y")+
  scale_linetype_manual(name = NULL,
            values = c("Air Temp" = "solid",
...
png(filename = './png/gpp_reco_ts.png',width = 9.5,height = 5.5,units = 'in',res = 2000)
