...
carbonts <- ggplot(data = df_avg_23_24, aes(x=date))+
  ...
  scale_y_continuous(limits = c(-3.8, 4), expression('CO'[2]*' Flux (gC'~m^-2~d^-1*')'))+
  scale_x_date(name = NULL,
                   breaks = seq(as.Date("2022-12-01"), as.Date("2025-12-01"), by = "6 months"), date_labels = "%b %Y")+
...
methanets <- ggplot(data = df_avg_23_24, aes(x=date))+
  ...
  scale_x_date(name = NULL,
                   breaks = seq(as.Date("2022-12-01"), as.Date("2025-12-01"), by = "6 months"),
                   date_labels = "%b %Y")+
  scale_shape_manual(name = NULL,
            values = c("Gapfilled" = 1, 
                      "Measured" = 16),
            breaks = c("Gapfilled", "Measured"))+
  scale_color_manual(name = NULL, values = c("Methane Flux" = "mediumorchid"))
